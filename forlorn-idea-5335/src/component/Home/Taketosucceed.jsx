...
export const Taketosucceed = () => {
  return (
    <div className='taketosucceed'>
        ...
        <div className='find-your-diet'>
            <div className='find-your-diet-1'>
                <img style={{width:"60%",marginLeft:"80px",marginTop:"100px"}} src="https://s3.amazonaws.com/img.mynetdiary.com/images/cover-insights-Illustration-3@2x.png" alt="" />
            ...
            <div className='find-your-diet-2'>
            <img style={{width:"60%",marginLeft:"80px",marginTop:"100px"}} src="https://s3.amazonaws.com/img.mynetdiary.com/images/cover-insights-Illustration-4@2x.png" alt="" />
